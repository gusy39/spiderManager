package com.ecmoho.jpush.api.push.model;


import com.ecmoho.jpush.api.push.model.audience.Audience;
import com.ecmoho.jpush.api.push.model.notification.AndroidNotification;
import com.ecmoho.jpush.api.push.model.notification.IosNotification;
import com.ecmoho.jpush.api.push.model.notification.Notification;
import com.ecmoho.jpush.api.push.model.notification.PlatformNotification;
...
public class PushPayload implements PushModel {
    ...
    private final com.ecmoho.jpush.api.push.model.Platform platform;
    private final Audience audience;
    private final Notification notification;
    private final com.ecmoho.jpush.api.push.model.Message message;
    private com.ecmoho.jpush.api.push.model.Options options;
    private SMS sms;
    
    
    private PushPayload(com.ecmoho.jpush.api.push.model.Platform platform, Audience audience,
            Notification notification, com.ecmoho.jpush.api.push.model.Message message, com.ecmoho.jpush.api.push.model.Options options, SMS sms) {
    ...
    public void resetOptionsTimeToLive(long timeToLive) {
        if (null == options) {
            options = com.ecmoho.jpush.api.push.model.Options.newBuilder().setTimeToLive(timeToLive).build();
        } else {
    ...
    public static class Builder {
        ...
        public Builder setOptions(com.ecmoho.jpush.api.push.model.Options options) {
            this.options = options;
            return this;
        }
